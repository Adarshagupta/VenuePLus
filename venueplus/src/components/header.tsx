        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <div className="flex items-center space-x-8">
              <button className={`flex items-center space-x-1 transition-colors hover:text-blue-600 ${
            ...
            {session ? (
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href="/auth/signup"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all-smooth hover:scale-105 font-medium"
                >
                  Get Started
                </Link>
              </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-lg">
            <div className="px-6 py-4 space-y-4">
              <Link href="/destinations" className="block text-gray-700 hover:text-blue-600 py-2">
                Destinations
              </Link>
              <Link href="/packages" className="block text-gray-700 hover:text-blue-600 py-2">
                Packages
              </Link>
